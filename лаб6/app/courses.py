...
def reviews(course_id):
    ...
    pagination = course_repository.get_reviews_with_pagination(
        course_id, page=page, per_page=per_page, sort_by=sort_by
    )
    ...
    if current_user.is_authenticated:
        user_review = course_repository.get_user_review_for_course(course_id, current_user.id)
...
def create_review(course_id):
    ...
    existing_review = course_repository.get_user_review_for_course(course_id, current_user.id)
    if existing_review:
    ...
    try:
        course_repository.add_review(course_id, current_user.id, rating, text)
